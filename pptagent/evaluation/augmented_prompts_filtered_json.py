data = [
  ...
  {
    "original": "Alter font sizes so that less important contents have smaller fonts sizes in slide number {slide_num}.", #original과 생성된 프롬프트와 지시가 다름(original은 덜 중요한 걸 줄이는 건데 생성된 프롬프트들은 덜 중요한 건 줄이고 중요한 건 키우라 되어 있음)
    "generated_variants": [
  ...
  {
    "original": "Apply a light background fill to all text boxes on ppt slide number {slide_num} to enhance readability.", #생성변수에서 light의 의미가 가벼운, 밝은 두 의미로 해석이 갈림
    "generated_variants": [
  ...
  {
    "original": "Change the overall layout of ppt slide number {slide_num} to a two-column format, with balanced placement of text and images.", #생성된 프롬프트가 'balanced'를 균형있게와 대칭적으로 둘로 다르게 해석함
    "generated_variants": [
  ...
  {
    "original": "Replace all occurring logo images with a new logo image.", #original prompt에서 new logo의 정의가 불분명해서 생성이 애매하게 됨
    "generated_variants": [
  ...
  },
  {
    ...
    "generated_variants": [
      ...
      "Position 'Caution' in the footer of slide {slide_num}, using a style that is soft yet discernible.",
      #"Incorporate 'Caution' into the footer of slide {slide_num}, with a styling that is gentle but perceptible.",
      "Affix 'Caution' to the footer of slide {slide_num}, ensuring it is understated yet apparent.",
      "Add the label 'Caution' to the footer of slide {slide_num}, with a design that is subtle but clear."
    ]
  },
  {
    "original": "Insert a semi-transparent watermark 'Talk-to-your-slide' behind the main content of ppt slide number {slide_num}.",
    "generated_variants": [
      "Add a faint watermark 'Talk-to-your-slide' to the background of slide {slide_num}.",
      "Place a translucent company emblem or text behind the primary elements on slide {slide_num}.",
      "Embed a subtle watermark 'Talk-to-your-slide' beneath the main content on slide {slide_num}.",
      #"Overlay a semi-transparent brand image or title in the background of slide {slide_num}.",
      "Incorporate a light watermark 'Talk-to-your-slide' behind the key content on slide {slide_num}.",
      ...
      "Place a soft watermark 'Talk-to-your-slide' behind the primary content on slide {slide_num}."
    ]
  },
  # {
  ...
  {
    "original": "Add transition effects for all slides between slides to create a smoother presentation flow.",
    "generated_variants": [
      ...
      "Introduce transition animations for all slides to ensure a cohesive slide progression.",
      "Utilize slide transitions for all slides to improve the overall flow of your presentation.",
      "Implement effects between all slides to achieve a more polished presentation.",
      #"Add animations to slide changes to create a more engaging presentation flow.",
      "Integrate smooth transitions for all slides to connect slides more effectively.",
  ...
  },
  {
    ...
    "generated_variants": [
      ...
      "Switch the name of the presenter to John Doe in the slides.",
